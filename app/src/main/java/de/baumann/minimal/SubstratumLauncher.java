...
import static de.baumann.minimal.ThemerConstants.APK_SIGNATURE_PRODUCTION;
import static de.baumann.minimal.ThemerConstants.BASE_64_LICENSE_KEY;
import static de.baumann.minimal.ThemerConstants.BLACKLISTED_APPLICATIONS;
import static de.baumann.minimal.ThemerConstants.ENABLE_BLACKLISTED_APPLICATIONS;
import static de.baumann.minimal.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL;
import static de.baumann.minimal.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL;
import static de.baumann.minimal.ThemerConstants.ENFORCE_INTERNET_CHECK;
import static de.baumann.minimal.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION;
import static de.baumann.minimal.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION;
import static de.baumann.minimal.ThemerConstants.PIRACY_CHECK;
import static de.baumann.minimal.ThemerConstants.THEME_READY_GOOGLE_APPS;
            ...
            try {
                ...
                if (packageInfo.versionCode >= MINIMUM_SUBSTRATUM_VERSION) {
                    Intent intent = SubstratumLoader.launchThemeActivity(getApplicationContext(),
                            getIntent(), getString(R.string.theme_name), getPackageName());
